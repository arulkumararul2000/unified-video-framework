...
const UnifiedVideoPlayer = () => {
    ...
    const getPaywallConfig = () => {
        return {
            ...
            // OPTION 2: Payment Link Configuration with your backend API format
            gateways: [
                {
                    id: 'cashfree',
                    name: 'Cashfree',
            ...
            // Payment Link Configuration matching your backend's expected format
            paymentLink: {
                ...
                // Map to your backend's expected format (NOT Cashfree API directly)
                mapRequest: (paymentData) => {
                    console.log('🔄 Mapping payment request for backend API:', paymentData);
                    ...
                    // Your backend expects these specific field names
                    return {
                        // Required fields based on your backend validation
                        unit_amount: amount, // Number (not string)
                        source_type_id: 1, // Video source type ID
                        source_id: String(paymentData.videoId || videoData?.id), // Video ID as string
